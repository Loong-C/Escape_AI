...
- 大型产物：`E:\Escape\_AI`。
- 当前里程碑：双规则引擎、验证器、固定基线、OpenSpiel、神经 PUCT、自对弈训练、模型联赛、研究记录/分析器、D4 对称集成、先手效应与 raw/D4 棋力诊断、只读棋谱查看器。
...
.venv\Scripts\escape-ai analyze-evaluator-match --input "E:/Escape/_AI/games/champion-raw-vs-d4-strength-17x17-v1" --output "E:/Escape/_AI/runs/champion-raw-vs-d4-strength-17x17-v1/analysis.json"
